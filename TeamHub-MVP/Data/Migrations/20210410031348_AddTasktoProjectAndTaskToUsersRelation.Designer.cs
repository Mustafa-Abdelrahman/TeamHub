...
namespace TeamHub_MVP.Data.Migrations
{
    ...
    [Migration("20210410031348_AddTasktoProjectAndTaskToUsersRelation")]
    partial class AddTasktoProjectAndTaskToUsersRelation
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TeamHub_MVP.Models.Bug", b =>
                {
                    ...
                    b.Property<DateTime>("DebuggingEndDate")
                        .HasColumnType("datetime2");

                    b.Property<bool>("DebuggingIsInProgress")
                        .HasColumnType("bit");

                    b.Property<DateTime>("DebuggingStartDate")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("TeamHub_MVP.Models.Project", b =>
                {
                    ...
                    b.Property<bool>("HasReachedDeadLine")
                        .HasColumnType("bit");
                    ...
                    b.Property<bool>("IsPPT")
                        .HasColumnType("bit");

                    b.Property<bool>("IsProduction")
                        .HasColumnType("bit");

                    b.Property<bool>("IsUAT")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("TeamHub_MVP.Models.Team", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TeamHub_MVP.Models.UserProject", b =>
                {
                    b.Property<string>("UserID")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("TeamHub_MVP.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TeamHub_MVP.Models.User", b =>
                {
                    b.HasOne("TeamHub_MVP.Models.User", "Manager")
                        .WithMany()
